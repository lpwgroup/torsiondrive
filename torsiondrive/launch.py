...
from torsiondrive.qm_engine import EnginePsi4, EngineQChem, EngineTerachem, OpenMMEngine
...
def create_engine(enginename, inputfile=None, work_queue_port=None, native_opt=False, extra_constraints=None, combination=None):
    """
    ...
    """
    engine_dict = {'psi4': EnginePsi4, 'qchem': EngineQChem, 'terachem':EngineTerachem, 'openmm': OpenMMEngine}
...
def main():
    ...
    parser.add_argument('-combination', '--combination', default='amber', choices=['amber', 'opls'], help='Enter the combination rules needed for OpenMM.')
    ...
    engine = create_engine(args.engine, inputfile=args.inputfile, work_queue_port=args.wq_port, native_opt=args.native_opt, combination=args.combination)
