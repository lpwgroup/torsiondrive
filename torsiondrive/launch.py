...
from torsiondrive.qm_engine import EnginePsi4, EngineQChem, EngineTerachem, EngineOpenMM, EngineGaussian09, EngineGaussian16
...
def create_engine(enginename, inputfile=None, work_queue_port=None, native_opt=False, extra_constraints=None):
    ...
    """
    engine_dict = {'psi4': EnginePsi4, 'qchem': EngineQChem, 'terachem': EngineTerachem, 'openmm': EngineOpenMM, 'gaussian09': EngineGaussian09, 'gaussian16': EngineGaussian16}
...
def main():
    ...
    parser.add_argument('-e', '--engine', type=str, default="psi4", choices=['qchem', 'psi4', 'terachem', 'openmm','gaussian09', 'gaussian16'], help='Engine for running scan')
