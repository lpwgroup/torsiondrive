...
def plot_grid_contour(grid_data, method='imshow'):
    ...
    cs = plt.contour(x_array, y_array, z_mat, antialiased=True, colors='black')
...
def main():
    ...
    plot_grid_contour(grid_data, method=args.method)
